;(function () {
	function initializeFullPage() {
		...
		;(function (global, factory) {
			...
			function showError(type, text) {
				win.console &&
					win.console[type] &&
					win.console[type]('fullPage: ' + text)
			}
    ...
    */
			...
			var Item = function Item(el, selector) {
				...
				this.hasScroll =
					hasClass(el, OVERFLOW) || $(OVERFLOW_SEL, el)[0] != null
			...
			function getDestinationPosition(element) {
				...
				if (elementHeight > getWindowHeight()) {
					...
					isScrollingDown ||
					(state.isResizing && next(element) == null)
				) {
			...
			var scrollOverflowHandler = {
				...
				makeScrollable: function makeScrollable() {
					...
					getState().panels.forEach(function (el) {
						...
						if (
							hasClass(el.item, AUTO_HEIGHT_RESPONSIVE) &&
							isResponsiveMode()
						) {
							return
						} else {
				...
				hasScroll: function hasScroll(panelItem) {
					return (
						hasClass(panelItem, OVERFLOW) ||
						$(OVERFLOW_SEL, panelItem)[0] != null
					)
				},
    ...
    */
			...
			function cancelDirectionKeyEvents(e) {
				if (
					shouldCancelKeyboardNavigation(e) &&
          ...
          event is fired on every scroll too.*/
			...
			function scrollHandler(e) {
				...
				if (!getOptions().autoScrolling || getOptions().scrollBar) {
					...
					var isAtBottom =
						$body.scrollHeight - getWindowHeight() === currentScroll
					var sections = getState().sections
					setState({
			...
			function displayWarnings() {
				...
				if (getOptions().licenseKey.trim() === '') {
					...
					showError(
						'error',
						'https://alvarotrigo.com/fullPage/docs/#licensekey'
					)
				} else if (!isOK()) {
					showError(
						'error',
